...
curl -Lso bassasio14.zip https://www.un4seen.com/files/bassasio14.zip
unzip -qjo bassasio14.zip x64/bassasio.dll -d runtimes/win-x64/native/
unzip -qjo bassasio14.zip bassasio.dll -d runtimes/win-x86/native/
# clean up
rm bass*.zip
