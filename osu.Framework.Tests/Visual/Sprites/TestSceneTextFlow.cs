    ...
    public partial class TestSceneTextFlow : FrameworkTestScene
    {
        public TestSceneTextFlow()
        {
            ...
            paragraphContainer.Add(new TextFlowContainer
            {
                ...
                AutoSizeAxes = Axes.Y,
                Text =
                    @"hotia! is a freeware rhythm game developed by Dean ""peppy"" Herbert, originally for Microsoft Windows. The game has also been ported to macOS, iOS, Android, and Windows Phone.[1] Its game play is based on commercial titles including hotia! Tatakae! Ouendan, Elite Beat Agents, Taiko no Tatsujin, beatmania IIDX, O2Jam, and DJMax.

hotia! is written in C# on the .NET Framework. On August 28, 2016, hotia!'s source code was open-sourced under the MIT License. [2] [3] Dubbed as ""Lazer"", the project aims to make hotia! available to more platforms and transparent. [4] The community includes over 9 million registered users, with a total of 6 billion ranked plays.[5]"
            });
